...
class Configuration(object):
    ...
    def raise_if_invalid(self):
        ...
        if self.role_arn is not None:
            ...
            assert ("arn:aws:iam::" in self.role_arn or "arn:aws-cn:iam::" in self.role_arn or), "Expected role_arn to contain 'arn:aws:iam::' or 'arn:aws-cn:iam'. Got '{}'.".format(self.role_arn)
